...
const Footer = () => {
	...
	return (
		<div
			...
			style={{ background: 'url(/footer.png)', backgroundSize: '100vw 100vh' }}
		>
			<ArrowUpOutlined
				onClick={topFunction}
			...
			<div className={styles.infoWrapper}>
				<div style={{ color: 'white' }}>
					...
					<span style={{ fontSize: 16, marginBottom: 6 }}>
						台北市大安區羅斯福路四段1號
					</span>
					<span
						style={{
					...
					>
						...
						>
							<path
								d='M22.2194 1H3.78063C2.24493 1 1 2.09006 1 3.43471V13.6764C1 15.0211 2.24493 16.1111 3.78063 16.1111H22.2194C23.7551 16.1111 25 15.0211 25 13.6764V3.43471C25 2.09006 23.7551 1 22.2194 1Z'
								stroke='white'
								strokeMiterlimit='10'
							/>
							<path
								d='M1.88889 1.88889L10.3575 9.34125C11.8683 10.6708 14.1317 10.6708 15.6425 9.34125L24.1111 1.88889'
								stroke='white'
								strokeLinecap='round'
								strokeLinejoin='round'
							/>
							<path
								d='M9.88889 9L1.88889 15.6667M15.6667 9L24.1111 15.6667'
								stroke='white'
							/>
						</svg>
				...
				<div className={styles.iconGroup}>
					<div>
						<a
							href='https://www.facebook.com/NTUartfest'
							style={{
								filter: 'drop-shadow(4px 4px 12px rgba(0, 0, 0, 0.21))',
							}}
						>
							<svg
								width='25'
							...
							>
								<path
									d='M281,443.36c94.57-22.16,165-107,165-208.36,0-118.19-95.81-214-214-214S18,116.81,18,235c0,112.47,86.76,204.66,197,213.33l.37-149.75L161,298.42V236.76l54-.48,1-45.1S205,85,342,112v51.45H320.31S277,160.11,281,206.22l-.26,30.54h58.65L330,298.42H280.74L281,442v1'
									stroke='white'
								/>
							</svg>
						</a>
						<a
							href='www.instagram.com/ntuartfest'
							style={{
								filter: 'drop-shadow(4px 4px 12px rgba(0, 0, 0, 0.21))',
							}}
						>
					...
					<div>
						...
						<a
							href='https://www.youtube.com/@ntuartfest'
							style={{
								filter: 'drop-shadow(4px 4px 12px rgba(0, 0, 0, 0.21))',
							}}
						>
