...
const { Meta } = Card;
import ArtBox from '../ArtBox/artBoxText';

const ArtImg = ({ tagName, imgUrl, inBreakPoint }) => {
    return (
...
// const Event = ({ tagName, imgUrl, title, date, inBreakPoint }) => {
//     return (
//         <Card
//             hoverable
...
function ArtList({ data = DefaultData }) {
