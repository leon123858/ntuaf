...
export const ArtworkImg = ({ data = test }) => {
    ...
    return (
        <>
            <div className={styles.container} >
                <Card bordered={false} style={{ width: "100%" }} hoverable onClick={() => { setOpen(true) }} cover={<img alt="img" src="https://imgs.gvm.com.tw/upload/gallery/20221204/125075.jpg" />}>
                    <ArtworkName>{data.artworkName}</ArtworkName>
                    <CreaterName>{data.name}</CreaterName>
                </Card>
                <div className={styles.heart}>
            ...
            >
                ...
                <br />
                <Image witdh={"100%"} src="https://imgs.gvm.com.tw/upload/gallery/20221204/125075.jpg"></Image>
                <Text>
                    <br />
                    {data.text}
                </Text>
